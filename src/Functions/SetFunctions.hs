...
dmSubmodularFunctionQuestion = subsection "DM QUESTION 2013" $ do
    todo "move this to the DM chapter"
    let v = mathcal "V"
        pv = powset v
        n = "n"
        x = "x"
...
dmSubmodularFunctionProbabilityQuestion = subsection "DM QUESTION 2014" $ do
    let v = mathcal "V"
        pv = powset v
        g' = "G"
        g = fn g'
