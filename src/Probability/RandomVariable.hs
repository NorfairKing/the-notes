...
saMeasureDefinition = de $ do
    ...
    todo "Define measures seperately"
...
hoeffdingsInequalityTheorem = do
    ...
    con $ do
        let a = alpha
        s ["Let", m $ a ∈ ooint 0 1, "and let", m xs, be, independent, and, "identically distributed", yRvs $ setofs [0, 1], "as follows"]
        let p = "p"
        ma $ fa i $ prob (xi =: 1) =: p
